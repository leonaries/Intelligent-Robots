...
export function LivePresence({ locale }: LivePresenceProps) {
  ...
  return (
    <div className="hidden items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-2 text-xs font-medium text-slate-300 md:flex">
      <span
        className={cn(
          'size-1.5 rounded-full',
          isConnected
            ? 'bg-cyan-200 shadow-[0_0_16px_rgba(103,232,249,0.9)]'
            : 'bg-slate-500'
        )}
      />
