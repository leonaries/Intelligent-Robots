        ...
        <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {content.metrics.map((metric) => (
            ...
            >
              ...
              <h2 className="mt-4 min-h-12 text-sm font-medium leading-6 text-theme-text-soft">
                {metric.name}
              </h2>
              <div className="mt-4 text-3xl font-semibold tracking-tight text-theme-text">
                {metric.value}
              </div>
              <div className="mt-2 flex items-center justify-between text-sm">
                <span className="text-theme-text-muted/70">{metric.period}</span>
